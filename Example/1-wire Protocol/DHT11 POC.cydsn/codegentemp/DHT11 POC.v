// ======================================================================
// DHT11 POC.v generated from TopDesign.cysch
// 02/22/2017 at 10:34
...
module top ;
	...
	wire [0:0] tmpOE__DHT_net;
	wire [0:0] tmpFB_0__DHT_net;
	wire [0:0] tmpINTERRUPT_0__DHT_net;
	electrical [0:0] tmpSIOVREF__DHT_net;
	...
	cy_psoc3_pins_v1_10
		...
		DHT
		 (.oe(tmpOE__DHT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DHT_net[0:0]}),
		  .io({Net_20}),
		  .siovref(tmpSIOVREF__DHT_net),
		  .interrupt({tmpINTERRUPT_0__DHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
